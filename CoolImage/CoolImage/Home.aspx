<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="CoolImage.Home" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head id="Head1" runat="server">
    <title>我的相册——Cool Imagic</title>
        ...
        <div class="Logo">      <!--logo行-->
            ...
            <div class="user_info"><!--左侧用户资料部分-->
               <br />
                ...
                <br />
                用户描述：<asp:Label ID="UserDescriptionL" runat="server"></asp:Label>
            </div>
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="相册信息">
                        <ItemTemplate>
                            <div style="height: 18px; width: 355px; text-align:left">
                                相册名：<asp:Label ID="Label1" runat="server" Text='<%# Eval("albumName") %>'></asp:Label>
                            </div>
                            <div style="height: 126px; width: 353px; margin-right: 0px; text-align:left">
                                相册描述：<br />
